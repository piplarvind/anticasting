(function ($) {
    ...
    var dzChartlist = (function () {
        ...
        var widgetChart1 = function () {
            console.log("receivedAmt", receivedAmt);
                        ...
                        datasets: [
                            {
                                ...
                                //data: [12, 13, 10, 18, 14, 24, 16, 12, 19, 21, 16, 14]
                                data: receivedAmt,
                            },
                        ],
                    },
        ...
        var widgetChart3 = function () {
            if (jQuery("#widgetChart3").length > 0) {
                const widgetChart3 = document
                    .getElementById("widgetChart3")
                    .getContext("2d");
                //generate gradient
                const widgetChart3gradientStroke =
                    widgetChart3.createLinearGradient(0, 1, 0, 500);
                widgetChart3gradientStroke.addColorStop(
                    0,
                    "rgba(30, 170, 231, 0.7)"
                );
                widgetChart3gradientStroke.addColorStop(
                        ...
                        datasets: [
                            {
                                ...
                                data: [
                                    12, 20, 16, 13, 16, 24, 20, 21, 19, 23, 17,
                                    14, 24, 21, 13, 15, 27, 29, 21, 11, 14, 19,
                                    21, 17,
                                ],
                            },
                        ],
        ...
        var lineChart = function () {
            ...
            if (jQuery("#lineChart").length > 0) {
                ...
                const lineChart = document
                    ...
                    .getContext("2d");
                //generate gradient
                const lineChart_3gradientStroke1 =
                    lineChart.createLinearGradient(500, 0, 100, 0);
                lineChart_3gradientStroke1.addColorStop(
                    0,
                    "rgba(26, 51, 213, 1)"
                );
                lineChart_3gradientStroke1.addColorStop(
                ...
                const lineChart_3gradientStroke2 =
                    lineChart.createLinearGradient(500, 0, 100, 0);
                lineChart_3gradientStroke2.addColorStop(
                    0,
                    "rgba(56, 164, 248, 1)"
                );
