...
(function (factory) {
    ...
    var defaults = {
        ...
        dataUrl: "../../../public/all_country_code.json",
        countryFilter: true,
    ...
    function CcPicker(element, options) {
        ...
        function setCountryByPhoneCode(code) {
            ...
            self._ccPicker.html(
                self.createCountryListItem(cc.code, cc.phoneCode)
            );
    ...
    $.extend(CcPicker.prototype, {
        ...
        createCountryList: function (e) {
            var zIndex = 999; //e._ccPicker.css("z-index") === "auto" ? 0 : Number(e._ccPicker.css("z-index")) + 10;
            e._list = $("<ul/>", { class: "cc-picker-code-list" }).appendTo(
                "body"
            );
            e._list.css({
                top:
                    ...
                    (e.options.countryFilter === true ? 25 : 0),
            ...
            if (e.options.countryFilter) {
                ...
                e._filter.on("keyup", function (e) {
                    ...
                    $(
                        '.cc-picker-code-list li:ccContains("' + text + '")'
                    ).show();
                });
            }
        },
