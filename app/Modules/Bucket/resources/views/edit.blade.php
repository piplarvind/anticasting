        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <hr />
                        <form action="{{ route('admin.bucket.manage.update',$item->id) }}" method="post"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bucket_name" class="form-control"
                                            value="{{ old('bucket_name',isset($item->bucket_name) ? $item->bucket_name:" " ) }}" placeholder="Enter bucket name" />
                                        @error('bucket_name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="movie_name" class="form-control"
                                            value="{{ old('movie_name',isset($item->movie_name) ? $item->movie_name:" " ) }}" placeholder="Enter movie name" />
                                        @error('movie_name')
                                            <span style="color:red;"><b>{{ $message }}</b></span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="description" class="form-control" id="description" placeholder="Enter movie description">
                                            {{ $item->description }}
                                        </textarea>
                                        @error('description')
                                            <span style="color:red;"><b>{{ $message }}</b></span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        value="{{ old('movie_name',isset($item->movie_link) ? $item->movie_link:" " )}}"  placeholder="Enter move link" />
                                        @error('movie_link')
                                            <span style="color:red;"><b>{{ $message }}</b></span>
                                        @enderror
                                    </div>
