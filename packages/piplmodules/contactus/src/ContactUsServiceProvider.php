...
namespace Piplmodules\Contactus;
...
class ContactUsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        */
        ...
        $this->publishes([
            __DIR__.'/views' => base_path('resources/views/vendor/contactus'),
        ], 'views');
        ...
        */
        ...
        $this->publishes([
            __DIR__.'/Lang/' => resource_path('lang/vendor/contactus'),
        ], 'lang');
        ...
        */
        $this->publishes([
            __DIR__.'/Public' => public_path('vendor/contactus'),
        ], 'public');
    ...
    public function register()
    {
        ...
        */
        ...
        //$this->app->make('Piplmodules\Banners\Controllers\BannersApiController');
        //$this->app->make('Piplmodules\Banners\Controllers\BannersController');
    }
}
