            ...
            <div class="all-ourt-style w-80-cust">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        @include('SendingCountry::sendingcountry.filter')
                                                ...
                                                <td>
                                                    <span class="act-link">
                                                        <a class="btn btn-primary shadow btn-xs sharp mr-1"
                                                            href="{{ route('admin.country.send.edit', $item->id) }}"
                                                            data-toggle="tooltip" data-placement="top" title=""
                                                            data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                                                    </span>
                                                    <span class="act-link">
                                                        <a class="btn btn-danger shadow btn-xs sharp"
                                                            href="{{ route('admin.country.send.delete', $item->id) }}"
...
@section('footer-scripts')
    ...
    <script>
        function changeTopicStatus(id, status) {
            ...
            jQuery.get("{{ route('admin.country.send.change-status') }}", obj_params, function(msg) {
                if (msg.error == "1") {
