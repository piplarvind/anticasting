@php
$itemTitle = $pageTitle = 'Send Country';

$pageNameMode = trans('Core::operations.create');
$breadcrumbs[] = ['url' => route('admin.country.send'), 'name' => $pageTitle];
$action = route('admin.country.send.store');
$method = '';
...
if (request()->is('*/edit')) {
    ...
    $action = route('admin.country.send.update', $item->id);
    $method = 'PATCH';
            ...
            <div class="all-ourt-style w-80-cust">
                <div class="all-heads">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.country.send') }}">{{ $pageTitle }}</a>
                        </li>
                    ...
                    <div class="card-body">
                        <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="text-center">
                                ...
                                <a class="btn btn-light" href="{{ route('admin.country.send') }}">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
