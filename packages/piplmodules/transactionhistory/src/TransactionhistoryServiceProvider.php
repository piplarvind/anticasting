...
namespace Piplmodules\Transactionhistory;
...
class TransactionhistoryServiceProvider extends ServiceProvider {
    ...
    public function boot() {
        ...
        $this->mergeConfigFrom(
                __DIR__ . '/config/transactionhistory.php', 'transactionhistory'
        );

        // Publish configuration if we need to customize configuration instead of default one.
        $this->publishes([
            __DIR__ . '/config/users.php' => config_path('transactionhistory.php'),
                ], 'config');
        ...
        $this->loadViewsFrom(__DIR__ . '/views', 'Transactionhistory');

        // Publish views if we need to customize views instead of default one. 
        $this->publishes([
            __DIR__ . '/views' => base_path('resources/views/vendor/transactionhistory'),
                ], 'views');
        ...
        $this->publishes([
            __DIR__ . '/Lang/' => resource_path('lang/vendor/transactionhistory'),
                ], 'lang');
         ...
         */
        $this->publishes([
            __DIR__ . '/Public' => public_path('vendor/transactionhistory'),
                ], 'public');
