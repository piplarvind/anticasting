            ...
            <div class="all-ourt-style w-80-cust">
                <div class="all-heads">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.transactions.history') }}"> <i class="fa fa-list"></i> Transfer
                                History</a>
                        </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="v-rec-price">
                                    ...
                                    <div class="q-s clearfix">
                                        ...
                                        <span
                                            class="v-tags pull-right">{{ $transaction_response->status_message }}</span>
                                    </div>
                                    {{-- </div> --}}
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="v-rec-time">
                                    <h4>Arrival Time:
                                        <span>{{ date('jS M, Y H:i:s A', strtotime($transaction_response->creation_date)) }}</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="v-reciver-bx">
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        {{ date('jS M, Y', strtotime($transaction_details->created_at)) }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        {{ $transaction_response->payer->currency }}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        {{ $transaction_response->purpose_of_remittance }}
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <th scope="row">Fee</th>
                                                    <td class="text-right">
                                                        {{ $transaction_details->fees . ' ' . $transaction_details->fees_currency }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        {{ $transaction_response->sent_amount->amount + $transaction_details->fees }}
                                                        {{ $transaction_response->sent_amount->currency }}</td>
                                                </tr>
                                                <tr>
                                    ...
                                    @endif --}}
                                    <div class="dashboard-footer receipient-form-footer clearfix">
                                        <a class="normal-btn red-avts"
                                            href="{{ route('admin.transactions.history') }}">Back</a>
                                        <a class="normal-btn red-avts"
                                            href="{{ route('admin.generate-receipt-pdf', [$transaction_details->transaction_id]) }}"><i
