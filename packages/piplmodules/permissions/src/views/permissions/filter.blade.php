        ...
        <form action="" method="GET" class="form-inline">
        	...
        	@php
		  	...
		  	@include('Core::fields.input_text', [
                'field_name' => 'name',
                'name' => trans('Permissions::permissions.role'),
                'value' => $nameValue,
                'placeholder' => ''
            ])
            ...
            @include('Core::fields.select', [
		  	...
		  	<a href="{{ action('\Piplmodules\Permissions\Controllers\PermissionsController@index')}}" class="btn btn-default">{{ trans('Core::operations.reset') }}</a>
		</form>
