            ...
            <div class="all-ourt-style w-80-cust">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        @include('Testimonial::testimonial.filter')
...
@section('footer-scripts')
    ...
    <script>
        function changeStatus(testimonial_id, status) {
            ...
            jQuery.get("{{ route('admin.testimonials.change-status') }}", obj_params, function(msg) {
                if (msg.error == "1") {
                    alert("Sorry, the operation failed");
                } else {
                    /* toogling the bloked and active div of user*/
                    if (status == 1) {
                        $("#disable_div" + testimonial_id).css('display', 'inline-block');
                        $("#enable_div" + testimonial_id).css('display', 'none');
                    } else {
                        $("#enable_div" + testimonial_id).css('display', 'inline-block');
                        $("#disable_div" + testimonial_id).css('display', 'none');
                    }
