@php
$breadcrumbs[] =  ['url' => url('/').'/'.Lang::getLocale().'/admin/users/supervisors', 'name' => trans('Users::users.user_permission')];
@endphp
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="livicon" data-name="list" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i> {{trans('Users::users.user_permission')}}
                </h3>
            </div>
            <div class="panel-body">
                <form action="" method="POST" notification="form">
                    {{ csrf_field() }}
                    <div class="col-md-9">
