        ...
        <form action="" method="GET" class="form-inline">
        	...
        	@php
		  	...
		  	@include('Core::fields.input_text', [
                'field_name' => 'name',
                'name' => trans('Notifications::notifications.notification'),
                'value' => $nameValue,
                'placeholder' => ''
            ])
            ...
            @include('Core::fields.select', [
		  	...
		  	<a href="{{ action('\Piplmodules\Notifications\Controllers\NotificationsController@index')}}" class="btn btn-default">{{ trans('Core::operations.reset') }}</a>
		</form>
