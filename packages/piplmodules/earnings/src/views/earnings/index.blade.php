            ...
            <div class="all-ourt-style w-80-cust">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        @include('Earnings::earnings.filter')
                                        ...
                                        @foreach ($transfer_histories as $k => $transfer_history)
                                            <tr class="@if ($k % 2 == 0) even @else odd @endif pointer"
                                                ...
                                                <td class="user_name_col_{{ $transfer_history->id }}">
                                                    {{ $transfer_history->fees . ' ' . $transfer_history->fees_currency }}
                                                </td>
                                                <td>{{ date('jS M, Y H:i:s A', strtotime($transfer_history->created_at)) }}
                                                </td>
