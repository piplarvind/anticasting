<div class="nav-header">
    <a href="{{ url('admin/dashboard') }}" class="brand-logo">
        <img width="200" src="{{ asset('public/backend') }}/images/logo.jpg" height="100" alt="">
    </a>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                            <div class="header-info">
                                <span
                                    class="text-black">Hello,<strong>{{ Auth::user()->first_name }}</strong></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="{{ route('admin.users.edit', [auth()->user()->id]) }}"
                                ...
                                <svg id="icon-user1" xmlns="https://www.w3.org/2000/svg" class="text-primary"
